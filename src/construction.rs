...
/// * c_i: 
/// * c_o: 
pub fn build_thermal_network(building: &Building, c: &Construction, dt: f64, n_elements: &Vec<usize>, rs_i: f64, rs_o: f64, k_prime: & mut Matrix, full_rsi: &mut f64, full_rso: &mut f64, c_i: & mut f64, c_o: & mut f64 ) ->Result<(),String> {
